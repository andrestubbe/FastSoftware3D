...
JNIEXPORT void JNICALL Java_fastsoftware3d_rasterizer_NativeRasterizer_drawTexturedTriangleNative
  (JNIEnv *, jobject, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jintArray, jfloatArray, jintArray, jint, jint, jint, jint);
#ifdef __cplusplus
}
#endif
#endif